...
try
{
String q="insert into departmenttable (`d_name`) values(?)";
PreparedStatement mystatement=myconnection.prepareStatement(q);
mystatement.setString(1, request.getParameter("dname"));
...
if(mystatement.executeUpdate()==1)
{
        ...
        out.print("<h1 class='form-control'>Department Added Successfully. "+"</h1>");
    }
        ...
        <div class="container" style="height:">
            <h1 >Add Qualification</h1>
                ...
                <form class="form-control-static" name="form2"  method="post" >
                    ...
                    <input type="text" name="dname" class="form-control-static" placeholder="Department Name">
                      <br>
