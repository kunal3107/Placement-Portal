...
if(itemName1.equals("sname")) //control's name - textbox name
{
 name=value; 
}
...
path=config.getServletContext().getRealPath("/") + "subjectimages/" + imagename;
...
try
{
String q="insert into subjecttable(sname,simage)values(?,?)";
...
{
out.print("<h1 class='form-control'>Subject Added Successfully.</h1>");
}
}
...
//try
//{
//String q="insert into subjecttable (`sname`) values(?)";
//PreparedStatement mystatement=myconnection.prepareStatement(q);
            ...
            <h1 >Add Subject</h1>
                <br><br><br><br><br>
                 <form class="form" name="f1" method="post" enctype="multipart/form-data" >   
                    <input type="text" name="sname" class="form-control-static" placeholder="Subject Name"><br><br>
                    <input type="file" name="image" class="form-horizontal" >
