...
<%
  ...
  int id;
    ...
    {  
        ...
        {
       out.println("<script> alert('"+session.getAttribute("mail").toString()+"') </script>");
           try
{
...
id=myresult.getInt(1); 
 ...
 String pq="insert into mbastudentinfo (`id`, `email`, `gradname`, `collegemba`, `gradpy`,gmarks) values(?,?,?,?,?,?)";  
...
out.println("Error in Connection " + e.getMessage());
    ...
    <div class="login">
     <div class="form" >
        <div class="container" style="height:80px">
                ...
                <form class="form" name="f1" method="post">
                    
                       <table width="100%"  cellpadding="15px" cellspacing="30px" border="1px">
                           <thead> <tr ><th colspan="2"><h1 align="center">MBA Placement Registration</h1></th></tr>
 ...
 <tr><th><b>Board:</b></th>
     <td><input type="text"  name="db" placeholder="Board" ></td></tr>
                       ...
                       <tr><th colspan="2"><legend align='center'>Graduation</legend></th></tr> <tr><th><b>Name & Branch</b></th><td><input type="text" placeholder="Grad in" name="gname" required=""></td></tr>
...
<tr><th colspan="2"><legend align='center'>MBA</legend></th></tr> <tr><th><b>Marks (Without % Sign) (Till Date)</b></th><br>
