...
<body>
  ...
  <% 
      if(request.getParameter("submit2")!=null){
          ...
          if(!request.getParameter("tname").equals(""))
      {
    try
{
...
try
{
String q="insert into qualificationtable (`qname`) values(?)";
PreparedStatement mystatement=myconnection.prepareStatement(q);
mystatement.setString(1, request.getParameter("tname"));
...
if(mystatement.executeUpdate()==1)
{
        ...
        out.print("<h1 class='form-control'>Qualification Added Successfully. "+"</h1>");
    }
        ...
        <div class="container" style="height:">
            <h1 >Add Qualification</h1>
                ...
                <form class="form-control-static" name="form2"  method="post" >
                    ...
                    <input type="text" name="tname" class="form-control-static" placeholder="Qualification Name">
                      <br>
